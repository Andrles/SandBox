Кейс второго спринта
 
База данных, с которой вы будете работать, состоит из одной таблицы. В ней собраны объявления, опубликованные на сайте по поиску работы hh.ru в мае и июне 2024 года. 
...
Жёсткие, или ключевые, навыки (англ. hard skills, key skills) связаны с определённой профессиональной областью, например навыки программирования или экспертность в области финансов и бухгалтерии.
Мягкие навыки (англ. soft skills) не привязаны к конкретной области, а необходимы для выполнения различных задач, например критическое мышление, управленческие способности или тайм-менеджмент.
